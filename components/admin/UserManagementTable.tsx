            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 text-xs font-mono focus:outline-none focus:ring-2 focus:ring-rose-500"
                />
              </div>
